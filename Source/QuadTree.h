 ...
 */
UCLASS()
class FERO_API AQuadTree : public AActor
{
...
public:
	...
	void LoadMap(AHeightmap* heightmap);
	void LoadMap();
...
private:
	...
	void Lathe(const TArray<FVector>& points, TArray<FGeneratedMeshTriangle>& triangles, int32 segments);
